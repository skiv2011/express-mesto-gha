...
module.exports.getCards = (req, res) => { //модуль списка карточек
  Card.find({})
...
module.exports.createCard = (req, res) => {  //модуль создания карточки
...
module.exports.likeCard = (req, res) => { //модуль лайка
...
module.exports.deleteLikeCard = (req, res) => { //модуль удаления лайка
  Card.findByIdAndUpdate(
    req.params.cardId,
